...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://karlos814.github.io/";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("karolkuziminski1@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("haslo1haslo");
